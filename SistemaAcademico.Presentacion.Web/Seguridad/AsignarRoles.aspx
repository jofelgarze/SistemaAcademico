<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignarRoles.aspx.cs" EnableEventValidation="false" Inherits="SistemaAcademico.Presentacion.Web.Seguridad.AsignarRoles" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-6">            
            <asp:UpdatePanel ID="upnUsuarioRol" runat="server">
                <ContentTemplate>
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="dgvRoles" EventName="RowCommand"/>
                    <asp:AsyncPostBackTrigger ControlID="btnAsignarUsuario" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="dgvUsuarios" EventName="RowDeleted" />
                </Triggers>
            </asp:UpdatePanel>
