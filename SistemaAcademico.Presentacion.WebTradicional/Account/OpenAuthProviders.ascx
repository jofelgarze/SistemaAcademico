<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="SistemaAcademico.Presentacion.WebTradicional.Account.OpenAuthProviders" %>
